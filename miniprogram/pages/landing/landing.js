...
// CHG-20260518-05/06：OPENING PITCH 4 段重写
// - 把原四问 a 的核心点织入正文（4 条 a 注脚同步清空，见 data/issues.js）
// - 段 2 末尾加粗短句「它能改变什么，又不能承担什么」
// - 段 3 去掉开头「但」+ 加「技术能改变的，是脸上可量化的部分；而"变美"的感受……承诺」
// - 段 4 以「想变美并不浅薄」开头，合并原段 4 + 5 + 把 a3 反问句织入
const V3_PITCH_PARAGRAPHS = [
  ...
  },
  {
    parts: [
      ...
      { text: '它能改变什么，又不能承担什么', strong: true },
      { text: '。' }
    ]
  },
  {
    parts: [
      { text: '医美也不只是技术。技术能改变的，是脸上可量化的部分；而“变美”的感受，从来不是单靠技术兑现的承诺。它同时牵动着审美标准、身体感受、情绪压力、消费选择，以及一个更隐秘的问题：' },
      { text: '当我们想要改变自己的脸和身体时，我们真正想改变的是什么？', strong: true }
    ]
  },
  {
    parts: [
      { text: '想变美并不浅薄。但在改变之前，也许可以先问：我想实现的，是谁的想象？这一次，我们不急着赞成，也不急着反对——我们想把“变美”这件事放回更大的语境里：医学如何参与审美，技术如何改变身体经验，而“变得更好”又是如何被想象、被定义、被追求的。' }
    ]
  }
];
