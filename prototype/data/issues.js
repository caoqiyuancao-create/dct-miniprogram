  ...
  issues: [
    {
      ...
      // 本期四个分享侧面（最终文案 · 精简版）
      points: [
        { num: '01', title: '医学的界限是什么',     sub: '',
          body: '医美是医学技术，也有作用机制、适应证与风险边界。\n\n它能改变什么？又不能承担什么？' },
        { num: '02', title: '能做，该做？',       sub: '',
          body: '当技术越来越普及，问题不只是“能不能做”。\n\n还有：适不适合做？做到什么程度？' },
        { num: '03', title: '谁在定义更好',           sub: '',
          body: '滤镜、平台、流量与广告，正在塑造我们对“更好看”的想象。\n\n“更美”从来不只是个人选择。' },
        { num: '04', title: '改变之前，先问为什么',  sub: '',
          body: '想变美并不浅薄。\n\n但在改变之前，也许可以先问：我想实现什么样的想象？' },
      ],
      // 海报上的四个抛给讲者的问题（CHG-20260518-05：删除 a 注脚，内容下沉至 OPENING PITCH 正文）
      teaserQuestions: [
        { q: '医美的本质，是“医”，还是“美”？', a: '' },
        { q: '人人都适合医美吗？',             a: '' },
        { q: '医美一定会让人变美吗？',         a: '' },
    ...
    },
    {
      ...
      // 用于 review-detail · 烛光与赛道 B 版的结构化字段
      recap: {
        variant: 'candle-track',  // 调度提示：走 Vol02CandleDetail
